...
enum AppLocalization {
    ...
    static func text(_ key: String, lang: String) -> String {
        let table: [String: (zhHans: String, zhHant: String, en: String)] = [
            ...
            "settings.ai.title": ("AI 设置", "AI 設定", "AI"),
            "settings.ai.url": ("API Base URL", "API Base URL", "API Base URL"),
            "settings.ai.key": ("API Key", "API Key", "API Key"),
            "settings.ai.model": ("模型名称", "模型名稱", "Model"),
            "settings.ai.desc": ("将密钥保存在本地设备。", "將金鑰保存在本機。", "Your key is stored locally."),
            ...
            "settings.smart_lab": ("智能建议复查", "智能建議複查", "Smart Lab Suggestion"),
            "settings.smart_lab.interval": ("建议间隔：每 %@ 周", "建議間隔：每 %@ 週", "Suggested interval: every %@ weeks"),
            "settings.smart_lab.apply": ("使用建议", "使用建議", "Apply suggestion"),
            "settings.smart_lab.reason.no_report": ("尚无近期报告，建议尽快建立基线检查。", "尚無近期報告，建議盡快建立基線檢查。", "No recent report yet. Consider establishing a baseline check soon."),
            "settings.smart_lab.reason.abnormal": ("近期结果有波动，建议缩短复查间隔。", "近期結果有波動，建議縮短複查間隔。", "Recent results fluctuate. Consider a shorter recheck interval."),
            "settings.smart_lab.reason.early": ("HRT 初期建议更频繁复查。", "HRT 初期建議更頻繁複查。", "Early HRT usually benefits from more frequent checks."),
            "settings.smart_lab.reason.stable": ("近期结果稳定，可按常规间隔复查。", "近期結果穩定，可按常規間隔複查。", "Results look stable. A regular interval is reasonable."),
            "settings.ai_lab.title": ("AI 复查建议", "AI 複查建議", "AI Recheck Suggestion"),
            "settings.ai_lab.disclaimer": ("AI 建议仅供参考，不替代医生诊疗建议。", "AI 建議僅供參考，不替代醫師診療建議。", "AI suggestions are for reference only and do not replace medical advice."),
            "settings.ai_lab.generate": ("生成 AI 建议", "產生 AI 建議", "Generate AI Suggestion"),
            "settings.ai_lab.generating": ("生成中...", "產生中...", "Generating..."),
            "settings.ai_lab.done": ("已生成 AI 建议。", "已產生 AI 建議。", "AI suggestion generated."),
            "settings.ai_lab.failed": ("AI 建议生成失败：%@", "AI 建議產生失敗：%@", "AI suggestion failed: %@"),
            "settings.ai_lab.missing_key": ("请先在设置中填写 API Key。", "請先在設定中填寫 API Key。", "Please set your API key in Settings."),
            "settings.ai_lab.interval": ("AI 建议间隔：每 %@ 周", "AI 建議間隔：每 %@ 週", "AI suggested interval: every %@ weeks"),
            "settings.ai_lab.apply": ("应用 AI 间隔", "套用 AI 間隔", "Apply AI Interval"),
            ...
            "rle.title": ("RLE 记录", "RLE 記錄", "RLE Log"),
            "rle.empty.title": ("还没有 RLE 记录", "還沒有 RLE 記錄", "No RLE entries yet"),
            "rle.empty.desc": ("点击右上角 + 记录一次变化。", "點擊右上角 + 記錄一次變化。", "Tap + to add an entry."),
            "rle.add.title": ("新增 RLE 记录", "新增 RLE 記錄", "Add RLE Entry"),
            "rle.add.cancel": ("取消", "取消", "Cancel"),
            "rle.add.save": ("保存", "儲存", "Save"),
            "rle.add.save_ai": ("保存并生成分析", "儲存並產生分析", "Save & Generate Analysis"),
            "rle.add.section.main": ("变化记录", "變化記錄", "Change Log"),
            "rle.add.section.photo": ("照片", "照片", "Photo"),
            "rle.add.date": ("日期", "日期", "Date"),
            "rle.add.photo": ("选择照片", "選擇照片", "Select Photo"),
            "rle.add.photo.help": ("建议选择同角度、同光线的照片，便于对比。", "建議選擇同角度、同光線的照片，便於對比。", "Use similar angle/light for better comparison."),
            "rle.add.photo.required": ("请先选择一张照片。", "請先選擇一張照片。", "Please select a photo first."),
            "rle.ai.missing_key": ("请先在设置中填写 API Key。", "請先在設定中填寫 API Key。", "Please set your API key in Settings."),
            "rle.ai.missing_url": ("请先在设置中填写 API Base URL。", "請先在設定中填寫 API Base URL。", "Please set your API Base URL in Settings."),
            "rle.ai.generating": ("正在生成分析...", "正在產生分析...", "Generating analysis..."),
            "rle.ai.failed": ("生成失败：%@", "產生失敗：%@", "Failed to generate: %@"),
            "rle.detail.title": ("记录详情", "記錄詳情", "Entry Detail"),
            "rle.detail.section.main": ("记录", "記錄", "Entry"),
            "rle.detail.section.photo": ("照片", "照片", "Photo"),
            "rle.detail.section.ai": ("AI 分析", "AI 分析", "AI Analysis"),
            "rle.detail.delete_confirm_title": ("删除这条记录？", "刪除這條記錄？", "Delete this entry?"),
            "rle.detail.delete": ("删除", "刪除", "Delete"),
            "rle.detail.cannot_undo": ("删除后不可恢复。", "刪除後不可恢復。", "This action cannot be undone."),
